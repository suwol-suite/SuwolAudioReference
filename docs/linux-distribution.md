...
Suwol Audio Reference 0.1.2 publishes Linux test builds as a zip of the Electron `linux-unpacked` directory.
...
- AppImage, deb, rpm, Snap, and Flatpak packages are not part of the 0.1.2 distribution.
