# Suwol Audio Reference 0.1.5

## Summary

0.1.5 aligns the app metadata, release documentation, and release guards with the `v0.1.5` tag while keeping the unified Windows, Linux, and macOS release workflow.
...
- Package version and release-note checks for `v0.1.5`.
