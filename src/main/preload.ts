...
const api: SuwolAudioApi = {
  ...
  soundSnapshots: {
    list: (projectId) => ipcRenderer.invoke("soundSnapshots:list", projectId),
    create: (input) => ipcRenderer.invoke("soundSnapshots:create", input),
    get: (snapshotId) => ipcRenderer.invoke("soundSnapshots:get", snapshotId),
    delete: (snapshotId) => ipcRenderer.invoke("soundSnapshots:delete", snapshotId),
    freeze: (snapshotId) => ipcRenderer.invoke("soundSnapshots:freeze", snapshotId),
    setBaseline: (snapshotId) => ipcRenderer.invoke("soundSnapshots:setBaseline", snapshotId),
    compare: (input) => ipcRenderer.invoke("soundSnapshots:compare", input),
    compareCurrent: (input) => ipcRenderer.invoke("soundSnapshots:compareCurrent", input),
    rollbackPreview: (snapshotId) => ipcRenderer.invoke("soundSnapshots:rollbackPreview", snapshotId),
    rollbackApply: (input) => ipcRenderer.invoke("soundSnapshots:rollbackApply", input),
    changelogPreview: (input) => ipcRenderer.invoke("soundSnapshots:changelogPreview", input),
    changelogExport: (input) => ipcRenderer.invoke("soundSnapshots:changelogExport", input),
  },
  changeReviews: {
    list: (query) => ipcRenderer.invoke("changeReviews:list", query),
    createFromDiff: (input) => ipcRenderer.invoke("changeReviews:createFromDiff", input),
    createFromBaseline: (input) => ipcRenderer.invoke("changeReviews:createFromBaseline", input),
    get: (reviewId) => ipcRenderer.invoke("changeReviews:get", reviewId),
    update: (reviewId, input) => ipcRenderer.invoke("changeReviews:update", reviewId, input),
    archive: (reviewId) => ipcRenderer.invoke("changeReviews:archive", reviewId),
    updateItemStatus: (itemId, input) => ipcRenderer.invoke("changeReviews:updateItemStatus", itemId, input),
    bulkUpdateItems: (input) => ipcRenderer.invoke("changeReviews:bulkUpdateItems", input),
    updateItemNote: (itemId, input) => ipcRenderer.invoke("changeReviews:updateItemNote", itemId, input),
    exportPreview: (input) => ipcRenderer.invoke("changeReviews:exportPreview", input),
    export: (input) => ipcRenderer.invoke("changeReviews:export", input),
  },
  soundBoardExport: {
